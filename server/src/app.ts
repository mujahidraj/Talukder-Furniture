...
import bulkImageImportRoutes from './routes/bulkImageImport.routes.js';
...
app.use(helmet({
  ...
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'"], // #12 Fix: removed 'unsafe-inline' to strengthen CSP
...
app.use('/api/admin/bulk-image-import', bulkImageImportRoutes);
