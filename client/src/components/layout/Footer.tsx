      ...
      <div style={{ width: '100%', padding: '80px 24px', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '110px' }} className="flex-col md:flex-row">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
            <a href="https://www.facebook.com/share/1EDKxts4Nu/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <a href="https://www.instagram.com/talukder_plastic/" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
